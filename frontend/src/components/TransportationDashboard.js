...
import { Bus, Users, CheckCircle, Clock, TrendingUp, ShieldAlert, Loader2, Download, Search, AlertCircle } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white p-6 rounded-3xl border border-slate-200/60 shadow-premium gap-4">
        ...
        <div className="flex space-x-2 w-full md:w-auto">
          ...
          >
            ...
            <span>Export Transportation CSV</span>
          </button>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-slate-200/60 shadow-premium space-y-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-slate-100 pb-3 gap-2">
            <div>
              ...
              <p className="text-[10px] text-slate-400 mt-0.5">List of students enrolled in school bus transportation</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              <input
                ...
                className="block w-full pl-8 pr-3 py-1.5 border border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:border-indigo-600 text-xs"
              />
